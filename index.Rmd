...
To complement and extend our understanding of border crossing dynamics, there is also an additional dataset "Border Crossing Entry Data" sourced from the U.S. Department of Transportation. API has been calling to load this dataset and will merge with the first dataset to do further analysis. This dataset provides complementary insights from the U.S. perspective, covering similar details such as **port name, date, measure (vehicles, pedestrians, etc.), and crossing volumes**.

The research question is: **To what extent do seasonal patterns, geographic regions, day-of-week (weekday vs. weekend), and transportation mode explain daily border-crossing volumes into Canada between January 2018 and May 2019? Additionally, how do seasonal patterns and geographic concentrations manifest on the U.S. side of the Canada–U.S. boundary between January 2018 and May 2019?**

Within this question, there are four hypothesis:<br>
1. **Seasonality (Canada & U.S.)**: Peaks in summer and troughs in winter on both sides of the border.<br>
2. **Transportation Mode (Canada)**: Land crossings dominate across the whole boundary.<br>
3. **Regional Concentrations (Canada & U.S.)**: A small set of ports (both Canadian and U.S.) capture the bulk of crossing volume.<br>
4. **Cross-Border Comparison (Canada v.s. U.S.)**: Although the U.S. side is expected to follow the same summer-peak/winter-trough pattern and port-concentration structure, the overall volumes and exact timing of those peaks may differ from the Canadian experience.<br>
...
```{r fig.cap="Figure 3: Trend of Border Crossings by Region and Transportation Mode (Log Scale to show trends more obviously)",echo=FALSE}
library(dplyr)
library(plotly)
library(scales)
